<?php
	...
	// $qry="select * from register where phone='".$_COOKIE['phone']."'";
	...
	// 	echo "<script>alert($_GET['t'],$_GET['k'])</script>";
	// }
?>
<!DOCTYPE html>
<html lang="en">
		...
		<section id="mu-contact">
			<div class="container">
				<div class="row">
					...
					<strong>Chairman</strong> <br> Syed Salman- 70921 91115
					</div>
					<div style="text-align: center" class="col-md-6">
					<strong>General Secretary</strong> <br> Sai Mukkundan- 98407 60211
					</div>
				</div>
			</div>
		</section>
