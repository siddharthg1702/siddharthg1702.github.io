...
$remaining = 0;
// if($type == "Onsite")	{
// 	if($w == "Arduino Essentials" || $w == "Internet Of Things" || $w == "Arduino for Robotics")
// 		$remaining = 700*$t +- $total;
// 	else
		// $remaining = $total-($t*)
echo "<div class='mu-title-area'>
<h2 style = 'margin-top:2.5em' class='mu-title'>Registration for $w workshop</h2>
...
<form class='mu-register-form' action='registereduser.php?total=$total&tickets=$t&w_name=$w&type=$type&kits=$kit&rem=$remaining' method='post'>";
